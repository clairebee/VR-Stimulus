classdef BoxPanelMD < uiextras.CardPanel & uiextras.DecoratedPanel
    ...
    methods
        ...
        function obj = BoxPanelMD(varargin)
            ...
            obj.HGWidgets_.MaximizeButton = uicontrol('parent', obj.UIContainer, ...
                'style', 'checkbox', ...
                'cdata', uiextras.loadLayoutIcon( 'panelMaximize.png' ), ...
                'BackgroundColor', titleColor, ...
                'Visible', 'off', ...
                'Tag', 'uiextras:BoxPanelMD:MaximizeButton', ...
                'HandleVisibility', 'off', ...
                'tooltip', 'Maximize this panel' );
    ...
    methods
        ...
        function set.MinimizeFcn( obj, value )
            if isempty( value )
                set( obj.HGWidgets_.MaximizeButton, 'Visible', 'off', 'Callback', [] );
            else
                set( obj.HGWidgets_.MaximizeButton, 'Visible', obj.Visible, 'Callback', value );
            end
        end % set.MinimizeFcn
        ...
        function set.IsMinimized( obj, value )
            ...
            if value( obj.IsMinimized )
                set( obj.HGWidgets_.MaximizeButton, ...
        ...
        function value = get.MinimizeFcn( obj )
            value = get( obj.HGWidgets_.MaximizeButton, 'Callback' );
        end % get.MinimizeFcn
    ...
    methods( Access = protected )
        ...
        function redraw( obj )
            ...
            if ~isstruct( decor ) ...
                    ...
                    || ~isfield( decor, 'MaximizeButton' ) % this is the last widget constructed
                return
            end
            ...
            if ~isempty(decor.MaximizeButton)
                set(decor.MaximizeButton, 'Position', [buttonXPos-buttonWidth, pos(4)-titleSize, buttonWidth-1, buttonWidth-2]);
                if ~isempty( obj.MinimizeFcn )
                    set(decor.MaximizeButton,'Visible', 'on' );
                    buttonXPos = buttonXPos - buttonWidth;
                else
                    set(decor.MaximizeButton,'Visible', 'off' );
                end
            end
